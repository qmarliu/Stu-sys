...
void main_show()
{
	...
	printf("\033[%d;%dH\033[32m 2. 老 师 登 录", MAIN_X_SUB + 2, MAIN_Y_SUB );
...
{	
	...
	printf("\033[%d;%dH 3. 老 师 登 记", MAIN_X_SUB+5, MAIN_Y_SUB);
	printf("\033[%d;%dH 4. 老 师 查 找", MAIN_X_SUB+7, MAIN_Y_SUB);
